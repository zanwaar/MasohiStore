    ...
    <div class="container mx-auto py-8">
        <div class="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-gray-600">Temukan produk berkualitas dari UMKM Masohi</p>
            </div>
            <div class="flex gap-4">
                <div class="relative flex-1 md:w-[300px]">
                    <i class="fas fa-search absolute left-2 top-2.5 h-4 w-4 text-gray-400"></i>
                    <input  wire:model.live="searchTerm" type="text" placeholder="Cari produk..." class="search-input p-2 w-full rounded-md">
                </div>
                <div class="select-wrapper">
                    <select 
                        wire:change="updateSortOption($event.target.value)"
            ...
            <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70">
                <div class="p-4">
                    <div class="aspect-square w-full overflow-hidden rounded-lg bg-gray-100">
                        <img src="{{url ('storage/products', $product->images)}}" alt="Product" class="h-full w-full object-cover transition-transform hover:scale-105">
                    </div>
                </div>
                <div class="p-4">
