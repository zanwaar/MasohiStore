                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2 text-sm">
                                    <span class="text-uppercase px-2 py-1 rounded-full text-xs font-semibold   {{ $order->status_color }}">
                                        {{ $order->status }}
                                    </span>
                                </td>
                                <td class="px-4 py-2 text-sm">
                                    <span class="text-uppercase px-2 py-1 rounded-full text-xs font-semibold  {{ $order->payment_status_color }}">
